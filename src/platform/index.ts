...
class PlatformFactory {
  ...
  private async createPlatformAPI(): Promise<PlatformAPI> {
    ...
    const finalError = new Error(`Failed to initialize ${detection.type} platform after ${this.config.retryAttempts} attempts: ${lastError?.message}`);
