...
import type { 
  LayoutState as LayoutStateType,
  GridSettings,
  WorkspaceConfig
} from '@/types/layout';
  ...
  createDevToolsMiddleware({
    ...
    traceLimit: defaultDevToolsConfig.traceLimit
      ...
      addPanel: (panel) => {
        ...
        }), false, { type: LayoutActionType.ADD_PANEL, panel: newPanel });
      },
      ...
      updatePanel: (id, updates) => {
        ...
        }), false, { type: LayoutActionType.UPDATE_PANEL, panelId: id, updates });
      },
      ...
      removePanel: (id) => {
        ...
        }), false, { type: LayoutActionType.REMOVE_PANEL, panelId: id });
      },
      ...
      selectPanel: (id, multiSelect = false) => {
        ...
        }, false, { type: LayoutActionType.SELECT_PANEL, panelId: id });
      },

      deselectPanel: (id) => {
        set((state) => ({
          selectedPanelIds: state.selectedPanelIds.filter(selectedId => selectedId !== id),
        }), false, { type: LayoutActionType.DESELECT_PANEL, panelId: id });
      },
      ...
      setGridSnap: (enabled) => {
        ...
        }), false, { type: LayoutActionType.TOGGLE_GRID });
      },

      updateGridSettings: (settings) => {
        set((state) => ({
          gridSettings: { ...state.gridSettings, ...settings },
        }), false, { type: LayoutActionType.UPDATE_GRID_SETTINGS, settings });
      },
      ...
      startDrag: (panelId, startPosition) => {
        ...
        }, false, { type: LayoutActionType.START_DRAG, panelId, startPosition });
      },
      ...
      updateDrag: (currentPosition) => {
        ...
        }), false, { type: LayoutActionType.UPDATE_DRAG, currentPosition });
      },
      ...
      endDrag: () => {
        ...
        }), false, { type: LayoutActionType.END_DRAG });
      },
      ...
      startResize: (panelId, direction, startSize) => {
        ...
        }, false, { type: LayoutActionType.START_RESIZE, panelId, direction: direction as any, startSize });
      },
      ...
      updateResize: (currentSize) => {
        ...
        }), false, { type: LayoutActionType.UPDATE_RESIZE, currentSize });
      },
      ...
      endResize: () => {
        ...
        set((state) => ({
          ...
          panels: state.panels.map(panel =>
            panel.id === panelId 
              ? { ...panel, size: finalSize }
              : panel
          ),
        }), false, { type: LayoutActionType.END_RESIZE });
      },
      ...
      saveWorkspace: (name, description = '') => {
        ...
        }), false, { type: LayoutActionType.SAVE_WORKSPACE, workspace });
      },
      ...
      loadWorkspace: (workspaceId) => {
        ...
        set({
          ...
          selectedPanelIds: [],
        }, false, { type: LayoutActionType.LOAD_WORKSPACE, workspaceId });
      },
      ...
      deleteWorkspace: (workspaceId) => {
        ...
        }, false, { type: LayoutActionType.DELETE_WORKSPACE, workspaceId });
      },
      ...
      isValidPosition: (position, size, excludeId = '') => {
        ...
        const overlapping = state.panels.some(panel => {
          ...
          return !(position.x + size.width <= panel.position.x ||
