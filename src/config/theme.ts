...
// Dark theme configuration (piano black theme)
const darkTheme: Theme = {
  ...
  colors: {
    ...
    neutral: {
      ...
      800: '#1e293b',
      900: '#0f172a',
      950: '#020617',  // Pure black for piano black effect
    },
  },
  shadows: {
  ...
  backgrounds: {
    ...
    patterns: {
      ...
      diagonal: 'repeating-linear-gradient(45deg, transparent, transparent 2px, #1e293b 2px, #1e293b 4px)',
    },
    backdrop: {
      blur: {
        sm: '4px',
